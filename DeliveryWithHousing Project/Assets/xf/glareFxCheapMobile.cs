    ...
    [ExecuteInEditMode]
    public class glareFxCheapMobile : MonoBehaviour
    {
		
		public bool fastestMode = false;
	
		public float intensity = 5.0f;
		public float threshold = 0.5f;
		public int blurIteration = 0;
	...
	private void DownSample4x (RenderTexture source, RenderTexture dest)
	{
        ...
        void OnRenderImage(RenderTexture source, RenderTexture dest)
        {
			...
			//FourTapCone (source, buffer);
			//Graphics.Blit(buffer,dest,GetMaterial());
		
			if (fastestMode) blurIteration=0;
