...
public class BRoadPathFinder : MonoBehaviour 
{
	
	//Del
	
	public BRoadPlotter bRoadPathPlotter;
	//Singleton
	private static BRoadPathFinder instance;
	public static BRoadPathFinder Instance { get { return instance; } private set {} }
	...
	void Start () 
	{
		...
		BRoadPathFinder.Instance.CreateMap();
	}
	...
	public void FindPath(Vector3 startPos, Vector3 endPos, Action<List<Vector3>> listMethod)
	{
		...
		if (startNode != null)
		{
			...
			while (currentNode.parent != null)
			{
				...
				bRoadPathPlotter.Path.Add(new Vector3(currentNode.xCoord, currentNode.yCoord, currentNode.zCoord));
